        ...
        if counter != 0:
            ...
            if counter == 1:
                ...
                if secondsElapsed > 30:
                    ...
                    #upddated
                    marked_students.append(id)
                    Name = studentInfo['name']
                    Student_Branch = studentInfo['major']
                    Student_Attendance = studentInfo['total_attendance']



                    marked_name.append(Name)


        # Create a DataFrame from the marked_students list
                    df = pd.DataFrame({
                                        'Name': marked_name,
                                       'Student ID': marked_students,
...
# Export the DataFrame to an Excel file
                    df.to_excel('public/marked_students.xlsx', index=False)
